...
6. Test a commit and push it to make sure everything is connected with ```git commit -m "My Ruby Project 1!"```.
...
1. [Project approval sign up form](https://docs.google.com/forms/d/e/1FAIpQLSdt9Uhcl_JRTbl5mKRz5vQeaLyX9d2ytUIrAZsoGp5_gRyjRA/viewform)

1. [Sign up here for help with your squad lead.](https://docs.google.com/forms/d/e/1FAIpQLSe8YhHq1Av2H2-fSbWKMGxFGIKuciuJAQbK04ps642Tdh4bIA/viewform)
